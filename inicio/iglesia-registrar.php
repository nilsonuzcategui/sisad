...
<head>
    <title>SISAD | Registrar Iglesia</title>
        ...
        <div class="page-wrapper">
            ...
            <div class="row page-titles">
                <div class="col-md-5 align-self-center">
                    <h3 class="text-themecolor">Registrar Iglesia</h3>
                </div>
            ...
            <!-- ============================================================== -->
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="alert alert-success alert-rounded"> <i class="fa fa-comments-o"></i> Antes de Agregar la iglesia confirme que no esté registrado anteriormente.
                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="form-material m-t-40 row">
                                    ...
                                    <div class="form-group col-md-6 m-t-20">
                                        <label>Dirección especifica</label>
                                    ...
                                    <div class="form-group col-md-6 m-t-20">
                                        ...
                                        <select name="idtipo" class="form-control form-control-line" required>
                                            <option value="6" selected>Iglesia</option>
                                        </select>
                                    </div>
