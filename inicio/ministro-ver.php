...
if ($sesion['zonal'] == 1) {
    $terceros = get_terceros_por_zona($sesion['idobjeto']);
}elseif ($sesion['distrital'] == 1) {
    $terceros = get_terceros_por_distrito($sesion['idobjeto']);
}else {
    //NACIONAL
}
                ...
                <!-- ============================================================== -->
                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <h6 class="card-subtitle">Solo se muestran los terceros de su Zona asignada.</h6>
