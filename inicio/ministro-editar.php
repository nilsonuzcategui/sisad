...
<head>
    <title>SISAD | Editar Ministro</title>
                            ...
                            <div class="card-body">
                                ...
                                <div class="form-material m-t-40 row">
                                    ...
                                    <div class="form-group col-md-6 m-t-20">
                                        ...
                                        <input type="text" value="<?=$tercero['apellidos']?>" name="apellidos" class="form-control form-control-line" required>
                                    </div>
                                    <div class="form-group col-md-6 m-t-20">
                                        <label>Sexo *</label>
                                        <select name="sexo" class="form-control form-control-line" required>
                                            <option <?php echo ($tercero['sexo'] == 'Masculino') ? 'selected' : '' ;?> >Masculino</option>
                                            <option <?php echo ($tercero['sexo'] == 'Femenino') ? 'selected' : '' ;?> >Femenino</option>
                                        </select>
                                    </div>
                                    <div class="form-group col-md-6 m-t-20">
                                        <label>Estado Civil</label>
                                        <select name="estado_civil" class="form-control form-control-line">
                                            <option <?php echo ($tercero['estado_civil'] == 'Soltero(a)') ? 'selected' : '' ;?> >Soltero(a)</option>
                                            <option <?php echo ($tercero['estado_civil'] == 'Casado(a)') ? 'selected' : '' ;?> >Casado(a)</option>
                                            <option <?php echo ($tercero['estado_civil'] == 'Divorciado(a)') ? 'selected' : '' ;?> >Divorciado(a)</option>
                                            <option <?php echo ($tercero['estado_civil'] == 'Viudo(a)') ? 'selected' : '' ;?> >Viudo(a)</option>
                                        </select>
                                    </div>
                                    <div class="form-group col-md-6 m-t-20">
